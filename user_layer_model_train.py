...
def get_user_embedding(uid, user_age):
    print('---------------------------------3. get_user_embedding define User embedding matrix')
...
def get_publisher_layers(publisher):
    print('---------------------------------8. get_publisher_layers merge publisher embedding vector')
...
# book_titleText convolutional network for feature extraction
...
class mv_network(object):
    def __init__(self, batch_size=256):
        ...
        print('model.summary()The parameters of each layer of the output model are as follows：', self.model.summary())
    ...
    def train_step(self, x, y):
        ...
        with tf.GradientTape() as tape:
            ...
            uid, isbn_id, book_title, book_author, year_of_publication, publisher, user_age
            """
            print('train_step中的x是............：', x)
            print('train_step中的y是............：', y)
    ...
    def testing(self, test_dataset, step_num):
        ...
        print('The loss of model testing is: {:0.6f} ###### Calculation index mae is: {:0.6f}'.format(avg_loss.result(), self.ComputeMetrics.result()))
